            ...
            <div class="movie-box">
                ...
                <div class="movie-title">
                    ...
                    <button class="rating-button" onclick="showRatingPopup('<?php echo $popupId; ?>')">&#9733; <?php echo $ratings_watched[$m->__get('id_movie')]; ?></button>
                            ...
                            <button type="submit" <?php if($movieOnWatchlist[$m->__get('id_movie')]) { ?> class="remove-watched-button-colored" <?php } else { ?> class="remove-watched-button" <?php } ?> name="id_movie" value="<?php echo $m->__get('id_movie'); ?>" disabled >&#x2764;</button>
                             </form>
