            ...
            <div class="movie-box">
                ...
                <div class="movie-title">
                    ...
                    <button class="rating-button" onclick="showRatingPopup('<?php echo $popupId; ?>')">&#9733; <?php echo $ratings_watchlist[$m->__get('id_movie')]; ?></button>
                            <form method="post" action="<?php echo __SITE_URL . '/index.php?rt=watchlist/updateWatchlist' ;?>"  id="watchlistForm1">
                            <button type="submit" <?php if($movieOnWatchlist[$m->__get('id_movie')]) { ?> class="remove-watched-button-colored" <?php } else { ?> class="remove-watched-button" <?php } ?> name="id_movie" value="<?php echo $m->__get('id_movie'); ?>" ><i class='fas fa-film' style="font-size: 20px;"></i></button>
                             </form>
                            <form method="post" action="<?php echo __SITE_URL . '/index.php?rt=watchlist/updateWatched'; ?>" id="watchedForm1">
            ...
            <div class="movie-box">
                ...
                <div class="movie-title">
                    ...
                    <button class="rating-button" onclick="showRatingPopup('<?php echo $popupId; ?>')">&#9733; <?php echo $ratings_watched[$m->__get('id_movie')]; ?></button>
                            <form method="post" action="<?php echo __SITE_URL . '/index.php?rt=watchlist/updateWatchlist' ;?>"  id="watchlistForm2">
                            <button type="submit" <?php if($movieOnWatchlist[$m->__get('id_movie')]) { ?> class="remove-watched-button-colored" <?php } else { ?> class="remove-watched-button" <?php } ?> name="id_movie" value="<?php echo $m->__get('id_movie'); ?>" disabled ><i class='fas fa-film' style="font-size: 20px;"></i></button>
                             </form>
                            <form method="post" action="<?php echo __SITE_URL . '/index.php?rt=watchlist/updateWatched'; ?>"  id="watchedForm2">
                            <button type="submit" <?php if($movieOnWatched[$m->__get('id_movie')]) { ?> class="remove-watched-button-colored" <?php } else { ?> class="remove-watched-button" <?php } ?> name="id_movie" value="<?php echo $m->__get('id_movie'); ?>">&#x1F4FA;</button>
                            </form>
                    </div>
                    <div class="movie-atributes">
